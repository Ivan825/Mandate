...
5. **Virtual cards (Stripe Issuing).** Every card authorisation is decided in real time by the same policy engine; captures, reversals and refunds are reconciled.

## Product surface

- **Front door**: public landing page, terms and privacy, a four-step onboarding on first sign-in.
...
- **Stripe Issuing live**: needs a US/UK/EU entity; the code path is written and test-mode ready.
