...
const OPEN = ["/sign-in", "/consent", "/a/", "/api/auth", "/api/agent", "/api/mcp", "/api/proxy", "/api/receipts", "/api/webhooks", "/api/cron", "/api/health", "/oauth2", "/.well-known", "/terms", "/privacy", "/invite/"];
